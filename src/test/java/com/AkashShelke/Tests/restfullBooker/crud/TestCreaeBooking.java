...
import com.AkashShelke.Base.BaseTest;
import com.AkashShelke.POJOs.responcePoJO.restfullBooker.BookingResponse;
import com.AkashShelke.endpoint.APIConstants;
...
//encapsulation used
public class TestCreaeBooking extends BaseTest {
    ...
    public void testCreateBookingPOST_Positive() {
        ...
        assertActions.verifyStringKey(bookingResponse.getBooking().getFirstname(), "Akash");
    }
    @Test(groups = "reg", priority = 1)
    @Owner("Akash Shelke")
