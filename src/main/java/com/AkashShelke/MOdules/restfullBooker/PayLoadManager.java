package com.AkashShelke.MOdules.restfullBooker;

import com.AkashShelke.POJOs.reqPoJO.restfullBuker.Auth;
import com.AkashShelke.POJOs.reqPoJO.restfullBuker.Booking;
import com.AkashShelke.POJOs.reqPoJO.restfullBuker.BookingDates;
import com.AkashShelke.POJOs.responcePoJO.restfullBooker.BookingResponse;
import com.AkashShelke.POJOs.responcePoJO.restfullBooker.InvalidTokenResponse;
import com.AkashShelke.POJOs.responcePoJO.restfullBooker.TokenResponse;
import com.github.javafaker.Faker;
import com.google.gson.Gson;

public class PayLoadManager {

    // Serialization and Deserialization we will do in pay load manager by using gson library
...
//        }
    ...
    public String createPayloadBookingAsStringWrongBody(){
        Booking booking = new Booking();
        booking.setFirstname("会意");
        booking.setLastname("会");
        booking.setTotalprice(112);
